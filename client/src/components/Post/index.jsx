...
const Post = ({userId, firstName, lastName, location, post ,postId }) => {
    ...
    return <>
        <Box sx={{ display: "flex", flexDirection: "column", justifyContent: "center" }} p="0.5rem 1rem" m="0.5rem" width={isNonMobile ? "40%" : "90%"} boxShadow="0px 0px 10px 0px black" borderRadius="1rem">
            <Box display="flex" justifyContent="space-between" width="100%">
                ...
                <DeleteOutlineIcon sx={{p:"0.5rem",borderRadius:"1rem",":hover":{bgcolor:"lightgray"}}} onClick={deletePost}/>
            </Box>
